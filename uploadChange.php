...
if (isset($_POST['btn-upload'])) {
    ...
    $folder="/Users/Jonathan/Sites/PHPDatabaseProject/uploads/";
    ...
    if (move_uploaded_file($file_loc, $folder.$final_file)) {
        ...
        try {
            ...
            $stmt = $conn->prepare("UPDATE ManagerCertificate SET ManagerID=:LoginID, Certificate=:File WHERE CertificateID=:id");
            ...
            header("Location: certificate.php?msg=successfully+changed+certificate.");
        } catch (PDOException $e) {
            header( "Location: certificate.php?msg=". $e->getMessage());
        }
    } else {
        header("Location: certificate.php?msg=error+changing+file,+file+probably+too+big,+please+keep+it+under+100k");
    }
}
